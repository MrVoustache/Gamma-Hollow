...
public class TubeCoralTreeFeature extends AbstractCoralTreeFeature {

    static private int MAX_STEPS = 100;
    static private float HORIZONTAL_AFFINITY = 1.0f;

    public TubeCoralTreeFeature(Codec<NoneFeatureConfiguration> codec) { super(codec); }

    @Override
    protected BlockState getTrunkBlock(FeaturePlaceContext<NoneFeatureConfiguration> context) { return Blocks.TUBE_CORAL_BLOCK.defaultBlockState(); }

    @Override
    protected BlockState getTopBlock(FeaturePlaceContext<NoneFeatureConfiguration> context) { return Blocks.TUBE_CORAL.defaultBlockState(); }

    @Override
    protected BlockState getFanBlock(FeaturePlaceContext<NoneFeatureConfiguration> context) { return Blocks.TUBE_CORAL_FAN.defaultBlockState(); }

    @Override
    protected BlockState getWallFanBlock(FeaturePlaceContext<NoneFeatureConfiguration> context) { return Blocks.TUBE_CORAL_WALL_FAN.defaultBlockState(); }
